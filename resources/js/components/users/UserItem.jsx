...
function UserItem({ user }) {
    ...
    const addFriend = async () => {
        ...
        await axios.post('/api/friends/request/send', { "id": user.id }, axiosConfig)
            .then(result => {
                setFriendStatus(0)
            })
            .catch(err => {
    ...
    const cancelRequest = async () => {
        setSendReqLoading(true);
        await axios.delete(`/api/friends/${user.id}/request/delete`, axiosConfig)
            .then(result => {
                setFriendStatus(-1)
            })
            .catch(err => {
    ...
    const acceptFriend = async () => {
        setSendReqLoading(true);
        axios.put(`/api/friends/${user.id}/request/accept`, {}, axiosConfig)
            .then(result => {
                setFriendStatus(1)
            })
            .catch(err => {
