...
function Error404() {
    ...
    return (
        <div className="px-16 md:px-0 flex items-center justify-center h-screen">
            <div className="bg-white flex flex-col items-center justify-center px-4 md:px-8
     lg:px-24 py-8 rounded-lg">
                ...
                onClick={goHome}
                 ...
                 cursor-pointer
                 hover:bg-blue-700 text-gray-100 px-4 py-2 mt-6 rounded transition duration-150" title="Return Home">
